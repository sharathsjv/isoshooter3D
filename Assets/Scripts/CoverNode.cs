...
public class CoverNode : MonoBehaviour
{
    ...
    void Update()
    {
        if (Physics.Raycast(transform.position,(player.transform.position - transform.position)*Range, Range,CoverMask))
        {
        ...
        // if (Physics.Raycast(transform.position,(player.transform.position - transform.position).normalized, Range,PlayerMask))
        // {
        ...
        // CoverHiddenFromPlayer = Physics.Raycast(transform.position,(player.transform.position - transform.position).normalized, Range,PlayerMask);
        // Debug.DrawLine(transform.position, (player.transform.position - transform.position)*Range, Color.white);
