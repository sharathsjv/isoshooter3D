...
public class NonAlertWalkingState : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        EnemyCharacterBrain.navMeshAgent.SetDestination(EnemyCharacterBrain.WaitNodes[EnemyCharacterBrain.currentNodePointer].transform.position);
